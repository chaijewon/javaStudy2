...
public class 이항연산자_산술연산자2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		 * int a=(int)(Math.random()*100)+1; // Math.random() => 0.0~0.99 ==> 0.0~99.0
		 * => 정수형 0~99 +1 // 1~100 System.out.println("a="+a);
		 * 
		 * Scanner scan=new Scanner(System.in); // System.in => 키보드입력값을 받는다
